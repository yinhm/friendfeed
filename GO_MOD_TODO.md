...
- [x] 分词：`github.com/go-ego/gse` 0.80.2 → 1.0.2；锁定中英文 token 序列，并验证中文索引、查询与重开结果。
- [x] 实验库：`golang.org/x/exp` 2024-03-18 → 2026-07-18；项目仅使用 `utf8string` 做标题按 rune 截断，既有多字节与 42-rune 边界测试保持通过。
