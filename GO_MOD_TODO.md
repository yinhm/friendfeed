...
- [ ] Twitter 客户端：`github.com/dghubble/go-twitter` 2021-05-05 → 2022-11-04；核对 OAuth 1.0a 签名、callback 和错误处理。
- [ ] OAuth provider：`github.com/markbates/goth` 1.67.1 → 1.82.0；重点验证 Google/Twitter callback、`provider:user-id` 身份键和既有用户匹配。
- [ ] 配置：`github.com/spf13/viper` 1.8.1 → 1.21.0；验证配置路径、`~` 展开、环境变量和默认值语义。
